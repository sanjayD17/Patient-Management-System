...
public class PatientController {
    ...
    public ResponseEntity<ApiResponse<List<PatientResponseDTO>>> getPatients() {
        ...
        return ResponseEntity.ok(new ApiResponse<>("Fetched successfully", patients));
    }
    ...
    public ResponseEntity<ApiResponse<PatientResponseDTO>> createPatient(
        ...
        return ResponseEntity.ok(new ApiResponse<>("Created successfully", patientResponseDTO));    }
    ...
    public ResponseEntity<ApiResponse<PatientResponseDTO>>updatePatient
        ...
        return ResponseEntity.ok(new ApiResponse<>("Updated successfully", patientResponseDTO));
    }
